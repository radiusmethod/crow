...
@main
struct Ride: ParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "ride",
        abstract: "CLI for rm-ai-ide — manage sessions, terminals, and metadata",
        version: "0.1.0",
        subcommands: [
            Setup.self,
            NewSession.self,
...
struct Setup: ParsableCommand {
    static let configuration = CommandConfiguration(commandName: "setup", abstract: "First-time setup for rm-ai-ide")

    @Option(name: .long, help: "Development root path") var devRoot: String?

    func run() throws {
        print("Welcome to rm-ai-ide setup.\n")
        ...
        print("\nLaunch rm-ai-ide to get started.")
    }
}
